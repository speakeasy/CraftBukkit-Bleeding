...
=======
        ...
        if ((this.id != HEAL.id || entityliving1.at()) && (this.id != HARM.id || !entityliving1.at())) {
            if (this.id == HARM.id && !entityliving1.at() || this.id == HEAL.id && entityliving1.at()) {
                j = (int) (d0 * (6 << i) + 0.5D);
>>>>>>> c98f107... Initial commit
=======
        int j;
